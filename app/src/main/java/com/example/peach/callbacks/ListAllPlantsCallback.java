...
import com.example.peach.listeners.ListAllPlantsListener;
import com.example.peach.models.SummarizedPlantsListModel;

public class ListAllPlantsCallback implements Callback<List<SummarizedPlantsListModel>>
{
    private Context context;
    private ListView listView;
    private String url;

    public ListAllPlantsCallback(Context context, ListView listView, String url)
    {
    ...
    private void setListener(List<SummarizedPlantsListModel> model)
    {
        this.listView.setOnItemClickListener(new ListAllPlantsListener(this.context, model, this.url));
    }
