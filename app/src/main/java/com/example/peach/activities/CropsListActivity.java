...
import com.example.peach.callbacks.CropsListCallback;
...
{
    private Button cropsListBackButton;
    ...
    private void loadUI()
    {
        ...
        this.listView = findViewById(R.id.cropsListView);
        this.cropsListBackButton = findViewById(R.id.cropsListBackButton);
        this.cropsListBackButton.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View view)
            {
                CropsListActivity.super.finish();
            }
        });
    }
    ...
    private void fetch()
    {
        ...
        Call<List<CropsListModel>> call = api.getAllCrops();
        call.enqueue(new CropsListCallback(this, this.listView, this.url));
    }
